        ...
        <table class="table table-bordered">
            ...
            <c:forEach items="${supplier}" var="supplier">
                <tr>
                    ...
                    <td>
                        <a href="/supplierForm/${supplier.id}"><span class="glyphicon glyphicon-edit"></span></a>
...
<button type="button" class="button" ONCLICK="location.href='/supplierForm'"><span class="glyphicon glyphicon-plus-sign"></span></button>
