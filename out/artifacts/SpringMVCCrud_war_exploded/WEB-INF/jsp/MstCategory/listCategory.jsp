...
<<<<<<< HEAD:target/SpringMVCCrud/WEB-INF/jsp/MstCategory/listCategory.jsp
        // //add
        // $(document).on('click', '.add_data', function () {
        //     $('#name').val("");
        // });
=======
>>>>>>> remotes/origin/ff/final:out/artifacts/SpringMVCCrud_war_exploded/WEB-INF/jsp/MstCategory/listCategory.jsp
    </script>
</head>
<body>
